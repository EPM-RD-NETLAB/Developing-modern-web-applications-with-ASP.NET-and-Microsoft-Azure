...
*По окончании тренинга Вы будете уметь*
 ...
 -	*строить архитектуру разрабатываемого приложения в соответствии с принципами ООП и SOLID*
 -	*пользоваться сторонними программами и инструментами в процессе разработки реальных программных продуктов*
 -	*настраивать взаимодействие Web-сайтов с базами данных*
 -	*проектировать и разрабатывать web-системы с использованием технологий ASP.NET и Microsoft Azure*

**Успешно освоившим программу всего тренинга будет предоставлена возможность начать карьеру в компании EPAM или продолжить обучение в .NET Lab.**
...
##  <a name="2"></a> Offline stage (внешний)
 ...
 - периодичность и место прохождения занятий - 2-3 раза в неделю по 4-5 академических часа по будням в учебных классах .NET Lab (ул. Купревича, 1/5) и совместной лаборатории БГУИР-EPAM (4-ый корпус БГУИР, ул. Гикало, 9);
...
##  <a name="3"></a> .NET Lab Stage (web part внешний или внутренний?)
 - зачисление по результатам Offline stage;
 - продолжительность 1 месяц;
 - периодичность и место прохождения занятий - 3 раза в неделю по 4 академических часа по будням в учебных классах .NET Lab (ул. Купревича, 1/5) и совместной лаборатории БГУИР-EPAM (4-ый корпус БГУИР, ул. Гикало, 9);
 - материалы в открытом доступе на [GitHub](https://github.com/EPM-RD-NETLAB).
